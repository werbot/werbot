...
var file_server_proto_depIdxs = []int32{
	...
	59, // 3: server.Server.Response.locked_at:type_name -> google.protobuf.Timestamp
	59, // 4: server.Server.Response.archived_at:type_name -> google.protobuf.Timestamp
	59, // 5: server.Server.Response.updated_at:type_name -> google.protobuf.Timestamp
	59, // 6: server.Server.Response.created_at:type_name -> google.protobuf.Timestamp
	1,  // 7: server.AddServer.Request.scheme:type_name -> server.ServerScheme
	32, // 8: server.UpdateServer.Request.info:type_name -> server.UpdateServer.Info
	59, // 9: server.UpdateServer.Response.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 10: server.ServerAccess.Response.auth:type_name -> server.Auth
	37, // 11: server.ServerAccess.Response.key:type_name -> server.ServerAccess.Key
	41, // 12: server.UpdateServerActivity.Request.activity:type_name -> server.ServerActivity.Response
	6,  // 13: server.AddSession.Request.status:type_name -> server.SessionStatus
	59, // 14: server.AddSession.Request.created_at:type_name -> google.protobuf.Timestamp
	52, // 15: server.ListShareServers.Response.servers:type_name -> server.ListShareServers.Response.SharedServer
	24, // 16: server.ServerHandlers.ListServers:input_type -> server.ListServers.Request
	26, // 17: server.ServerHandlers.Server:input_type -> server.Server.Request
	28, // 18: server.ServerHandlers.AddServer:input_type -> server.AddServer.Request
	30, // 19: server.ServerHandlers.UpdateServer:input_type -> server.UpdateServer.Request
	33, // 20: server.ServerHandlers.DeleteServer:input_type -> server.DeleteServer.Request
	35, // 21: server.ServerHandlers.ServerAccess:input_type -> server.ServerAccess.Request
	38, // 22: server.ServerHandlers.UpdateServerAccess:input_type -> server.UpdateServerAccess.Request
	40, // 23: server.ServerHandlers.ServerActivity:input_type -> server.ServerActivity.Request
	42, // 24: server.ServerHandlers.UpdateServerActivity:input_type -> server.UpdateServerActivity.Request
	50, // 25: server.ServerHandlers.ListShareServers:input_type -> server.ListShareServers.Request
	53, // 26: server.ServerHandlers.AddShareServer:input_type -> server.AddShareServer.Request
	55, // 27: server.ServerHandlers.UpdateShareServer:input_type -> server.UpdateShareServer.Request
	57, // 28: server.ServerHandlers.DeleteShareServer:input_type -> server.DeleteShareServer.Request
	44, // 29: server.ServerHandlers.UpdateHostKey:input_type -> server.UpdateHostKey.Request
	46, // 30: server.ServerHandlers.AddSession:input_type -> server.AddSession.Request
	48, // 31: server.ServerHandlers.ServerNameByID:input_type -> server.ServerNameByID.Request
	25, // 32: server.ServerHandlers.ListServers:output_type -> server.ListServers.Response
	27, // 33: server.ServerHandlers.Server:output_type -> server.Server.Response
	29, // 34: server.ServerHandlers.AddServer:output_type -> server.AddServer.Response
	31, // 35: server.ServerHandlers.UpdateServer:output_type -> server.UpdateServer.Response
	34, // 36: server.ServerHandlers.DeleteServer:output_type -> server.DeleteServer.Response
	36, // 37: server.ServerHandlers.ServerAccess:output_type -> server.ServerAccess.Response
	39, // 38: server.ServerHandlers.UpdateServerAccess:output_type -> server.UpdateServerAccess.Response
	41, // 39: server.ServerHandlers.ServerActivity:output_type -> server.ServerActivity.Response
	43, // 40: server.ServerHandlers.UpdateServerActivity:output_type -> server.UpdateServerActivity.Response
	51, // 41: server.ServerHandlers.ListShareServers:output_type -> server.ListShareServers.Response
	54, // 42: server.ServerHandlers.AddShareServer:output_type -> server.AddShareServer.Response
	56, // 43: server.ServerHandlers.UpdateShareServer:output_type -> server.UpdateShareServer.Response
	58, // 44: server.ServerHandlers.DeleteShareServer:output_type -> server.DeleteShareServer.Response
	45, // 45: server.ServerHandlers.UpdateHostKey:output_type -> server.UpdateHostKey.Response
	47, // 46: server.ServerHandlers.AddSession:output_type -> server.AddSession.Response
	49, // 47: server.ServerHandlers.ServerNameByID:output_type -> server.ServerNameByID.Response
