...
const file_project_proto_rawDesc = "" +
	"\n" +
	"\rproject.proto\x12\aproject\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a0pkg/utils/protoutils/ghoster/proto/ghoster.proto\"\xf9\x01\n" +
	...
	"\bprojects\x18\x02 \x03(\v2\x19.project.Project.ResponseR\bprojects\"\x91\x06\n" +
	"\aProject\x1ax\n" +
	"\aRequest\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin\x12&\n" +
	...
	"\x05limit\x18\x04 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x05 \x01(\x05R\x06offset\x12\x17\n" +
	"\asort_by\x18\x06 \x01(\tR\x06sortBy\x1aR\n" +
	"\bResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x05R\x05total\x120\n" +
	"\x04keys\x18\x02 \x03(\v2\x1c.project.ProjectKey.ResponseR\x04keys\"\xd5\x05\n" +
	"\n" +
	"ProjectKey\x1a\x87\x01\n" +
	"\aRequest\x124\n" +
	"\x06public\x18\x03 \x01(\v2\x1a.project.ProjectKey.PublicH\x00R\x06public\x127\n" +
	"\aprivate\x18\x04 \x01(\v2\x1b.project.ProjectKey.PrivateH\x00R\aprivateB\r\n" +
	...
	"\n" +
	"\bResponse2\xd5\x05\n" +
	"\x0fProjectHandlers\x12C\n" +
	"\bProjects\x12\x19.project.Projects.Request\x1a\x1a.project.Projects.Response\"\x00\x12@\n" +
	"\aProject\x12\x18.project.Project.Request\x1a\x19.project.Project.Response\"\x00\x12I\n" +
	"\n" +
	"AddProject\x12\x1b.project.AddProject.Request\x1a\x1c.project.AddProject.Response\"\x00\x12R\n" +
	"\rUpdateProject\x12\x1e.project.UpdateProject.Request\x1a\x1f.project.UpdateProject.Response\"\x00\x12R\n" +
	"\rDeleteProject\x12\x1e.project.DeleteProject.Request\x1a\x1f.project.DeleteProject.Response\"\x00\x12L\n" +
	"\vProjectKeys\x12\x1c.project.ProjectKeys.Request\x1a\x1d.project.ProjectKeys.Response\"\x00\x12I\n" +
	"\n" +
	"ProjectKey\x12\x1b.project.ProjectKey.Request\x1a\x1c.project.ProjectKey.Response\"\x00\x12R\n" +
	"\rAddProjectKey\x12\x1e.project.AddProjectKey.Request\x1a\x1f.project.AddProjectKey.Response\"\x00\x12[\n" +
	"\x10DeleteProjectKey\x12!.project.DeleteProjectKey.Request\x1a\".project.DeleteProjectKey.Response\"\x00B>Z<github.com/werbot/werbot/internal/core/project/proto/projectb\x06proto3"
