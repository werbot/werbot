...
type FirewallHandlersClient interface {
	IPAccess(ctx context.Context, in *message.IPAccess_Request, opts ...grpc.CallOption) (*message.IPAccess_Response, error)
	UpdateFirewallListData(ctx context.Context, in *message.UpdateFirewallListData_Request, opts ...grpc.CallOption) (*message.UpdateFirewallListData_Response, error)
}
...
func (c *firewallHandlersClient) IPAccess(ctx context.Context, in *message.IPAccess_Request, opts ...grpc.CallOption) (*message.IPAccess_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.IPAccess_Response)
...
func (c *firewallHandlersClient) UpdateFirewallListData(ctx context.Context, in *message.UpdateFirewallListData_Request, opts ...grpc.CallOption) (*message.UpdateFirewallListData_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.UpdateFirewallListData_Response)
...
type FirewallHandlersServer interface {
	IPAccess(context.Context, *message.IPAccess_Request) (*message.IPAccess_Response, error)
	UpdateFirewallListData(context.Context, *message.UpdateFirewallListData_Request) (*message.UpdateFirewallListData_Response, error)
...
func (UnimplementedFirewallHandlersServer) IPAccess(context.Context, *message.IPAccess_Request) (*message.IPAccess_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IPAccess not implemented")
}
func (UnimplementedFirewallHandlersServer) UpdateFirewallListData(context.Context, *message.UpdateFirewallListData_Request) (*message.UpdateFirewallListData_Response, error) {
...
func _FirewallHandlers_IPAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.IPAccess_Request)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FirewallHandlersServer).IPAccess(ctx, req.(*message.IPAccess_Request))
	}
...
func _FirewallHandlers_UpdateFirewallListData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.UpdateFirewallListData_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FirewallHandlersServer).UpdateFirewallListData(ctx, req.(*message.UpdateFirewallListData_Request))
	}
	return interceptor(ctx, in, info, handler)
}
