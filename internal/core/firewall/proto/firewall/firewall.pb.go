...
const file_firewall_proto_rawDesc = "" +
	"\n" +
	"\x0efirewall.proto\x12\bfirewall\x1a\x1bbuf/validate/validate.proto\"^\n" +
	"\fAccessPolicy\x12&\n" +
	...
	"\x02ip\x10\x022\xca\x01\n" +
	"\x10FirewallHandlers\x12E\n" +
	"\bIPAccess\x12\x1a.firewall.IPAccess.Request\x1a\x1b.firewall.IPAccess.Response\"\x00\x12o\n" +
	"\x16UpdateFirewallListData\x12(.firewall.UpdateFirewallListData.Request\x1a).firewall.UpdateFirewallListData.Response\"\x00B@Z>github.com/werbot/werbot/internal/core/firewall/proto/firewallb\x06proto3"
