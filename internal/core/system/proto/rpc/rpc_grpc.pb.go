...
type SystemHandlersClient interface {
	ProfileMetrics(ctx context.Context, in *message.ProfileMetrics_Request, opts ...grpc.CallOption) (*message.ProfileMetrics_Response, error)
	Countries(ctx context.Context, in *message.Countries_Request, opts ...grpc.CallOption) (*message.Countries_Response, error)
	CountryByIP(ctx context.Context, in *message.CountryByIP_Request, opts ...grpc.CallOption) (*message.CountryByIP_Response, error)
}
...
func (c *systemHandlersClient) ProfileMetrics(ctx context.Context, in *message.ProfileMetrics_Request, opts ...grpc.CallOption) (*message.ProfileMetrics_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.ProfileMetrics_Response)
...
func (c *systemHandlersClient) Countries(ctx context.Context, in *message.Countries_Request, opts ...grpc.CallOption) (*message.Countries_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.Countries_Response)
...
func (c *systemHandlersClient) CountryByIP(ctx context.Context, in *message.CountryByIP_Request, opts ...grpc.CallOption) (*message.CountryByIP_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.CountryByIP_Response)
...
type SystemHandlersServer interface {
	ProfileMetrics(context.Context, *message.ProfileMetrics_Request) (*message.ProfileMetrics_Response, error)
	Countries(context.Context, *message.Countries_Request) (*message.Countries_Response, error)
	CountryByIP(context.Context, *message.CountryByIP_Request) (*message.CountryByIP_Response, error)
...
func (UnimplementedSystemHandlersServer) ProfileMetrics(context.Context, *message.ProfileMetrics_Request) (*message.ProfileMetrics_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method ProfileMetrics not implemented")
}
func (UnimplementedSystemHandlersServer) Countries(context.Context, *message.Countries_Request) (*message.Countries_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method Countries not implemented")
}
func (UnimplementedSystemHandlersServer) CountryByIP(context.Context, *message.CountryByIP_Request) (*message.CountryByIP_Response, error) {
...
func _SystemHandlers_ProfileMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.ProfileMetrics_Request)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemHandlersServer).ProfileMetrics(ctx, req.(*message.ProfileMetrics_Request))
	}
...
func _SystemHandlers_Countries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.Countries_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemHandlersServer).Countries(ctx, req.(*message.Countries_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SystemHandlers_CountryByIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.CountryByIP_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SystemHandlersServer).CountryByIP(ctx, req.(*message.CountryByIP_Request))
	}
	return interceptor(ctx, in, info, handler)
}
