...
type AgentHandlersClient interface {
	Auth(ctx context.Context, in *message.Auth_Request, opts ...grpc.CallOption) (*message.Auth_Response, error)
	// Agent section
	AddScheme(ctx context.Context, in *message.AddScheme_Request, opts ...grpc.CallOption) (*message.AddScheme_Response, error)
}
...
func (c *agentHandlersClient) Auth(ctx context.Context, in *message.Auth_Request, opts ...grpc.CallOption) (*message.Auth_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.Auth_Response)
...
func (c *agentHandlersClient) AddScheme(ctx context.Context, in *message.AddScheme_Request, opts ...grpc.CallOption) (*message.AddScheme_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.AddScheme_Response)
...
type AgentHandlersServer interface {
	Auth(context.Context, *message.Auth_Request) (*message.Auth_Response, error)
	// Agent section
	AddScheme(context.Context, *message.AddScheme_Request) (*message.AddScheme_Response, error)
...
func (UnimplementedAgentHandlersServer) Auth(context.Context, *message.Auth_Request) (*message.Auth_Response, error) {
	return nil, status.Error(codes.Unimplemented, "method Auth not implemented")
}
func (UnimplementedAgentHandlersServer) AddScheme(context.Context, *message.AddScheme_Request) (*message.AddScheme_Response, error) {
...
func _AgentHandlers_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentHandlersServer).Auth(ctx, req.(*message.Auth_Request))
	}
...
func _AgentHandlers_AddScheme_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.AddScheme_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentHandlersServer).AddScheme(ctx, req.(*message.AddScheme_Request))
	}
	return interceptor(ctx, in, info, handler)
}
