...
const file_profile_proto_rawDesc = "" +
	"\n" +
	"\rprofile.proto\x12\aprofile\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a0pkg/utils/protoutils/ghoster/proto/ghoster.proto\"\x8a\x01\n" +
	"\x11ProfileParameters\x12\x1d\n" +
	"\n" +
	"profile_id\x18\x01 \x01(\tR\tprofileId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\x05roles\x18\x03 \x01(\x0e2\r.profile.RoleR\x05roles\x12\x1d\n" +
	"\n" +
	...
	"\arefresh\x18\x02 \x01(\tR\arefresh\"\xdd\x02\n" +
	"\rResetPassword\x1a\xc9\x01\n" +
	"\aRequest\x12R\n" +
	"\x05email\x18\x01 \x01(\tB:\xbaH7\xba\x014\n" +
	"\vvalid_email\x12\x15must be a valid email\x1a\x0ethis.isEmail()H\x00R\x05email\x12 \n" +
	"\x05token\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01H\x00R\x05token\x12=\n" +
	"\bpassword\x18\x03 \x01(\v2\x1f.profile.ResetPassword.PasswordH\x00R\bpasswordB\t\n" +
	"\arequest\x1a)\n" +
	"\bResponse\x12\x1d\n" +
	"\n" +
	...
	"\x05token\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x05token\"\xd0\x01\n" +
	"\bProfiles\x1ak\n" +
	"\aRequest\x12\x19\n" +
	...
	"\bprofiles\x18\x02 \x03(\v2\x19.profile.Profile.ResponseR\bprofiles\"\xc8\x05\n" +
	"\aProfile\x1aM\n" +
	"\aRequest\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin\x12'\n" +
	"\n" +
	"profile_id\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\tprofileId\x1a\xed\x04\n" +
	"\bResponse\x12\x1d\n" +
	"\n" +
	...
	"\x04role\x18\b \x01(\x0e2\r.profile.RoleB\x04\x88\xb5\x18\x01R\x04role\x12 \n" +
	...
	"\x06status\x18\x02 \x01(\x0e2\x0f.profile.StatusR\x06status\x1a\n" +
	"\n" +
	"\bResponse*>\n" +
	"\x04Role\x12\x14\n" +
	...
	"\n" +
	"\x06online\x10\x022\xf4\x06\n" +
	"\x0fProfileHandlers\x12>\n" +
	"\x06SignIn\x12\x17.profile.SignIn.Request\x1a\x19.profile.Profile.Response\"\x00\x12R\n" +
	"\rResetPassword\x12\x1e.profile.ResetPassword.Request\x1a\x1f.profile.ResetPassword.Response\"\x00\x12C\n" +
	"\bProfiles\x12\x19.profile.Profiles.Request\x1a\x1a.profile.Profiles.Response\"\x00\x12@\n" +
	"\aProfile\x12\x18.profile.Profile.Request\x1a\x19.profile.Profile.Response\"\x00\x12I\n" +
	"\n" +
	"AddProfile\x12\x1b.profile.AddProfile.Request\x1a\x1c.profile.AddProfile.Response\"\x00\x12R\n" +
	"\rUpdateProfile\x12\x1e.profile.UpdateProfile.Request\x1a\x1f.profile.UpdateProfile.Response\"\x00\x12R\n" +
	"\rDeleteProfile\x12\x1e.profile.DeleteProfile.Request\x1a\x1f.profile.DeleteProfile.Response\"\x00\x12U\n" +
	"\x0eUpdatePassword\x12\x1f.profile.UpdatePassword.Request\x1a .profile.UpdatePassword.Response\"\x00\x12[\n" +
	"\x10ProfileIDByLogin\x12!.profile.ProfileIDByLogin.Request\x1a\".profile.ProfileIDByLogin.Response\"\x00\x12N\n" +
	"\x0eProfileByEmail\x12\x1f.profile.ProfileByEmail.Request\x1a\x19.profile.Profile.Response\"\x00\x12O\n" +
	"\fUpdateStatus\x12\x1d.profile.UpdateStatus.Request\x1a\x1e.profile.UpdateStatus.Response\"\x00B>Z<github.com/werbot/werbot/internal/core/profile/proto/profileb\x06proto3"
