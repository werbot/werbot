...
type NotificationHandlersClient interface {
	SendMail(ctx context.Context, in *message.SendMail_Request, opts ...grpc.CallOption) (*message.SendMail_Response, error)
}
...
func (c *notificationHandlersClient) SendMail(ctx context.Context, in *message.SendMail_Request, opts ...grpc.CallOption) (*message.SendMail_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.SendMail_Response)
...
type NotificationHandlersServer interface {
	SendMail(context.Context, *message.SendMail_Request) (*message.SendMail_Response, error)
...
func (UnimplementedNotificationHandlersServer) SendMail(context.Context, *message.SendMail_Request) (*message.SendMail_Response, error) {
...
func _NotificationHandlers_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.SendMail_Request)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationHandlersServer).SendMail(ctx, req.(*message.SendMail_Request))
	}
