...
const file_audit_proto_rawDesc = "" +
	"\n" +
	"\vaudit.proto\x12\x05audit\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x01\n" +
	"\n" +
	"ListAudits\x1a0\n" +
	"\aRequest\x12%\n" +
	"\tserver_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\bserverId\x1aS\n" +
	"\bResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x05R\x05total\x121\n" +
	"\baccounts\x18\x02 \x03(\v2\x15.audit.Audit.ResponseR\baccounts\"\xba\x01\n" +
	"\x05Audit\x1a.\n" +
	"\aRequest\x12#\n" +
	...
	"\vListRecords\x1a.\n" +
	"\aRequest\x12#\n" +
	"\baudit_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\aauditId\x1a3\n" +
	"\bResponse\x12'\n" +
	"\arecords\x18\x01 \x03(\v2\r.audit.RecordR\arecords\"p\n" +
	"\tAddRecord\x1aW\n" +
	"\aRequest\x12#\n" +
	"\baudit_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\aauditId\x12'\n" +
	"\arecords\x18\x02 \x03(\v2\r.audit.RecordR\arecords\x1a\n" +
	"\n" +
	"\bResponse2\xf1\x03\n" +
	"\rAuditHandlers\x12E\n" +
	"\n" +
	"ListAudits\x12\x19.audit.ListAudits.Request\x1a\x1a.audit.ListAudits.Response\"\x00\x126\n" +
	"\x05Audit\x12\x14.audit.Audit.Request\x1a\x15.audit.Audit.Response\"\x00\x12?\n" +
	"\bAddAudit\x12\x17.audit.AddAudit.Request\x1a\x18.audit.AddAudit.Response\"\x00\x12H\n" +
	"\vUpdateAudit\x12\x1a.audit.UpdateAudit.Request\x1a\x1b.audit.UpdateAudit.Response\"\x00\x12H\n" +
	"\vDeleteAudit\x12\x1a.audit.DeleteAudit.Request\x1a\x1b.audit.DeleteAudit.Response\"\x00\x12H\n" +
	"\vListRecords\x12\x1a.audit.ListRecords.Request\x1a\x1b.audit.ListRecords.Response\"\x00\x12B\n" +
	"\tAddRecord\x12\x18.audit.AddRecord.Request\x1a\x19.audit.AddRecord.Response\"\x00B:Z8github.com/werbot/werbot/internal/core/audit/proto/auditb\x06proto3"
