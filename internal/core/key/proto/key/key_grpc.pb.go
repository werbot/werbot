...
func (c *keyHandlersClient) Keys(ctx context.Context, in *Keys_Request, opts ...grpc.CallOption) (*Keys_Response, error) {
...
func _KeyHandlers_Keys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyHandlersServer).Keys(ctx, req.(*Keys_Request))
	}
