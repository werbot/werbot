...
type LicenseHandlersClient interface {
	License(ctx context.Context, in *message.License_Request, opts ...grpc.CallOption) (*message.License_Response, error)
}
...
func (c *licenseHandlersClient) License(ctx context.Context, in *message.License_Request, opts ...grpc.CallOption) (*message.License_Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(message.License_Response)
...
type LicenseHandlersServer interface {
	License(context.Context, *message.License_Request) (*message.License_Response, error)
...
func (UnimplementedLicenseHandlersServer) License(context.Context, *message.License_Request) (*message.License_Response, error) {
...
func _LicenseHandlers_License_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(message.License_Request)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LicenseHandlersServer).License(ctx, req.(*message.License_Request))
	}
