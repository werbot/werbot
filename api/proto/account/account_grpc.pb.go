...
func (c *accountHandlersClient) ResetPassword(ctx context.Context, in *ResetPassword_Request, opts ...grpc.CallOption) (*ResetPassword_Response, error) {
	...
	err := c.cc.Invoke(ctx, "/account.AccountHandlers/ResetPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountHandlersClient) AccountIDByLogin(ctx context.Context, in *AccountIDByLogin_Request, opts ...grpc.CallOption) (*AccountIDByLogin_Response, error) {
	...
	err := c.cc.Invoke(ctx, "/account.AccountHandlers/AccountIDByLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountHandlers_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.AccountHandlers/SignIn",
	}
...
func _AccountHandlers_ResetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.AccountHandlers/ResetPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccountHandlers_AccountIDByLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.AccountHandlers/AccountIDByLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
