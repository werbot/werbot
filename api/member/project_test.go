	...
	testTable := []test.APITable{
		...
		{ // ADMIN:
			...
			Body: test.BodyTable{
				...
				"result.members.0.user_id":      "68bf07a3-0132-4709-920b-5054f9eaa89a",
				"result.members.0.user_name":    "Carla",
		...
		{ // ADMIN:
			...
			Body: test.BodyTable{
				...
				"result.members.1.user_id":       "b3dc36e2-7f84-414b-b147-7ac850369518",
				"result.members.1.user_name":     "Harrison",
		...
		{ // ADMIN:
			...
			Body: test.BodyTable{
				...
				"result.members.0.user_id":       "b3dc36e2-7f84-414b-b147-7ac850369518",
		...
		{ // ADMIN: search users without project
			Name:       "test1_08",
			Method:     http.MethodGet,
			...
			Body: test.BodyTable{
				"code":                   float64(200),
				"message":                "Users without project",
				"result.total":           float64(15),
				"result.users.0.email":   test.ConstAdminEmail,
				"result.users.0.alias":   "admin",
				"result.users.0.user_id": test.ConstAdminID,
			},
			RequestHeaders: adminHeader,
		},
		{ // ADMIN: search users without project for User UUID
			Name:       "test1_09",
			Method:     http.MethodGet,
			...
			Body: test.BodyTable{
				...
				"result.users.0.email":   test.ConstUserEmail,
				"result.users.0.alias":   "user",
				"result.users.0.user_id": test.ConstUserID,
			},
			RequestHeaders: adminHeader,
		},
		...
		{ // USER: search users without project
			Name:       "test2_06",
			Method:     http.MethodGet,
		...
		{ // USER: search users without project for User UUID
			Name:       "test2_07",
			Method:     http.MethodGet,
	...
	testTable := []test.APITable{
		...
		{ // ADMIN: request without parameters
			...
			Body: test.BodyTable{
				"code":           float64(400),
				"message":        "Bad Request",
				"result.user_id": "value is required",
			},
			RequestHeaders: adminHeader,
		},
		{ // ADMIN: request without parameters
			...
			Body: test.BodyTable{
				"code":           float64(400),
				"message":        "Bad Request",
				"result.user_id": "value must be a valid UUID",
			},
			RequestHeaders: adminHeader,
		},
		{ // ADMIN:
			...
			StatusCode: 200,
			RequestBody: test.BodyTable{
				"user_id": "51c12bb6-2da6-491d-8003-b024f54a1491",
			},
			Body: test.BodyTable{
				"code":             float64(200),
	...
	testTable := []test.APITable{
		...
		{ // ADMIN:
			...
			Body: test.BodyTable{
				...
				"result.user_name":    "value is required",
				"result.user_surname": "value is required",
			},
			RequestHeaders: adminHeader,
		},
		{ // ADMIN:
			...
			Body: test.BodyTable{
				...
				"result.user_name":    "required field (3 to 30 characters)",
				"result.user_surname": "required field (3 to 30 characters)",
			},
			RequestHeaders: adminHeader,
		},
		{ // ADMIN:
...
// TODO 1. registration if there is no user, 2. authorization if the user is not authorized,
